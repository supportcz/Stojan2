...
FUNCTION_BLOCK AsIOAccReadReg			(*reads noncyclical register (SGC only); asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
...
FUNCTION_BLOCK AsIOAccWriteReg			(*writes noncyclical register (SGC only); asynchronous execution*)
	VAR_INPUT
		enable			: BOOL;			(*enables execution*)
		nodeNr			: USINT;		(*node number of x2x module*)
		registerNr		: UINT;			(*register number*)
